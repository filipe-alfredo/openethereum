...
if [ "$1" == "yes" ]; then \
    ...
    sed -e "s|0x0000000000000000000000000000000000000005|"${ACCOUNT_ADDRESS}"|g" -e "s|NETWORK_NAME|"${NETWORK_NAME}"|g" ${BASE_PATH}/config/genesis.json.example > ${BASE_PATH}/config/genesis.json && \
